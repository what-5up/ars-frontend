...
const AccountTypesTable = ({ content, tableCaption, handleNew, handleUpdate, handleDelete }) => {
	return (
		<>
		...
		<div>
			{forNew ? (
				<Button colorScheme="teal" onClick={onOpen} m={4}>
					<AddIcon />
					<Text mx={2}>{forNew ? 'Add New Account Type' : 'Add New Account Type'}</Text>
				</Button>
			) : (
			...
			<Modal isOpen={isOpen} onClose={onClose} isCentered>
				<ModalOverlay />
				<ModalContent>
					<ModalHeader>{forNew? 'New Account Type':'Update Account Type'}</ModalHeader>
					<ModalCloseButton />
					<ModalBody>
						<Formik
							initialValues={{
						...
						>
							{(props) => (
								<Box>
									<FormControl isInvalid={props.errors.accountType && props.touched.accountType}>
										<Input
											type="text"
										...
										/>
										<FormErrorMessage>{props.errors.accountType}</FormErrorMessage>
									</FormControl>
									<FormControl isInvalid={props.errors.discount && props.touched.discount}>
									...
									<FormControl
										isInvalid={props.errors.bookingsCriteria && props.touched.bookingsCriteria}
									>
										...
										<FormErrorMessage>{props.errors.bookingsCriteria}</FormErrorMessage>
									</FormControl>
									<Box my={4}>
		...
		<div>
			...
			>
				...
				<AlertDialogContent>
					...
					<AlertDialogCloseButton />
					<AlertDialogBody>Are you sure you want to discard this account type?</AlertDialogBody>
					<AlertDialogFooter>
